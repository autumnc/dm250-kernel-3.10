...
static u8 pm_regs[256];

void warp_rk818_suspend (void)
{		
	struct rk818 *rk818 = g_rk818;

	pm_regs[0] = rk818_reg_read(rk818, RK818_CLK32OUT_REG);
	pm_regs[1] = rk818_reg_read(rk818, RK818_VB_MON_REG);
	pm_regs[1] &= ~((1 << 6) | (1 << 5) | (1 << 3));	/* RO */
	pm_regs[2] = rk818_reg_read(rk818, RK818_DCDC_EN_REG);
	pm_regs[3] = rk818_reg_read(rk818, RK818_LDO_EN_REG);
	pm_regs[4] = rk818_reg_read(rk818, RK818_SLEEP_SET_OFF_REG1);
	pm_regs[5] = rk818_reg_read(rk818, RK818_SLEEP_SET_OFF_REG2);
	pm_regs[6] = rk818_reg_read(rk818, RK818_BUCK1_CONFIG_REG);
	pm_regs[7] = rk818_reg_read(rk818, RK818_BUCK1_ON_REG);
	pm_regs[8] = rk818_reg_read(rk818, RK818_BUCK1_SLP_REG);
	pm_regs[9] = rk818_reg_read(rk818, RK818_BUCK2_CONFIG_REG);
	pm_regs[10] = rk818_reg_read(rk818, RK818_BUCK2_ON_REG);
	pm_regs[11] = rk818_reg_read(rk818, RK818_BUCK2_SLP_REG);
	pm_regs[12] = rk818_reg_read(rk818, RK818_BUCK3_CONFIG_REG);
	pm_regs[13] = rk818_reg_read(rk818, RK818_BUCK4_CONFIG_REG);
	pm_regs[14] = rk818_reg_read(rk818, RK818_BUCK4_ON_REG);
	pm_regs[15] = rk818_reg_read(rk818, RK818_BUCK4_SLP_VSEL_REG);
	pm_regs[16] = rk818_reg_read(rk818, RK818_BOOST_CONFIG_REG);
	pm_regs[17] = rk818_reg_read(rk818, RK818_LDO1_ON_VSEL_REG);
	pm_regs[18] = rk818_reg_read(rk818, RK818_LDO1_SLP_VSEL_REG);
	pm_regs[19] = rk818_reg_read(rk818, RK818_LDO2_ON_VSEL_REG);
	pm_regs[20] = rk818_reg_read(rk818, RK818_LDO2_SLP_VSEL_REG);
	pm_regs[21] = rk818_reg_read(rk818, RK818_LDO3_ON_VSEL_REG);
	pm_regs[22] = rk818_reg_read(rk818, RK818_LDO3_SLP_VSEL_REG);
	pm_regs[23] = rk818_reg_read(rk818, RK818_LDO4_ON_VSEL_REG);
	pm_regs[24] = rk818_reg_read(rk818, RK818_LDO4_SLP_VSEL_REG);
	pm_regs[25] = rk818_reg_read(rk818, RK818_LDO5_ON_VSEL_REG);
	pm_regs[26] = rk818_reg_read(rk818, RK818_LDO5_SLP_VSEL_REG);
	pm_regs[27] = rk818_reg_read(rk818, RK818_LDO6_ON_VSEL_REG);
	pm_regs[28] = rk818_reg_read(rk818, RK818_LDO6_SLP_VSEL_REG);
	pm_regs[29] = rk818_reg_read(rk818, RK818_LDO7_ON_VSEL_REG);
	pm_regs[30] = rk818_reg_read(rk818, RK818_LDO7_SLP_VSEL_REG);
	pm_regs[31] = rk818_reg_read(rk818, RK818_LDO8_ON_VSEL_REG);
	pm_regs[32] = rk818_reg_read(rk818, RK818_LDO8_SLP_VSEL_REG);
	pm_regs[33] = rk818_reg_read(rk818, RK818_BOOST_LDO9_ON_VSEL_REG);
	pm_regs[34] = rk818_reg_read(rk818, RK818_BOOST_LDO9_SLP_VSEL_REG);
	pm_regs[35] = rk818_reg_read(rk818, RK818_DEVCTRL_REG);
	pm_regs[35] &= ~0xf;
#if 0
	pm_regs[36] = rk818_reg_read(rk818, RK818_INT_STS_REG1);
#endif
	pm_regs[37] = rk818_reg_read(rk818, RK818_INT_STS_MSK_REG1);
	rk818_reg_write(rk818, RK818_INT_STS_MSK_REG1, 0xff);
#if 0
	pm_regs[38] = rk818_reg_read(rk818, RK818_INT_STS_REG2);
#endif
	pm_regs[39] = rk818_reg_read(rk818, RK818_INT_STS_MSK_REG2);
	rk818_reg_write(rk818, RK818_INT_STS_MSK_REG2, 0xff);
	pm_regs[40] = rk818_reg_read(rk818, RK818_IO_POL_REG);

	pm_regs[41] = rk818_reg_read(rk818, SUP_STS_REG);
	pm_regs[42] = rk818_reg_read(rk818, USB_CTRL_REG);
	pm_regs[43] = rk818_reg_read(rk818, CHRG_CTRL_REG1);
	pm_regs[44] = rk818_reg_read(rk818, CHRG_CTRL_REG2);
	pm_regs[45] = rk818_reg_read(rk818, CHRG_CTRL_REG3);
	pm_regs[46] = rk818_reg_read(rk818, BAT_CTRL_REG);
	pm_regs[47] = rk818_reg_read(rk818, BAT_HTS_TS1_REG);
	pm_regs[48] = rk818_reg_read(rk818, BAT_LTS_TS1_REG);
	pm_regs[49] = rk818_reg_read(rk818, BAT_HTS_TS2_REG);
	pm_regs[50] = rk818_reg_read(rk818, BAT_LTS_TS2_REG);
	pm_regs[51] = rk818_reg_read(rk818, TS_CTRL_REG);
	pm_regs[52] = rk818_reg_read(rk818, ADC_CTRL_REG);
	pm_regs[53] = rk818_reg_read(rk818, ON_SOURCE);
	pm_regs[54] = rk818_reg_read(rk818, OFF_SOURCE);
	pm_regs[55] = rk818_reg_read(rk818, GGCON);
	pm_regs[56] = rk818_reg_read(rk818, GGSTS);
	pm_regs[57] = rk818_reg_read(rk818, FRAME_SMP_INTERV_REG);
	pm_regs[58] = rk818_reg_read(rk818, AUTO_SLP_CUR_THR_REG);
	pm_regs[59] = rk818_reg_read(rk818, GASCNT_CAL_REG3);
	pm_regs[60] = rk818_reg_read(rk818, GASCNT_CAL_REG2);
	pm_regs[61] = rk818_reg_read(rk818, GASCNT_CAL_REG1);
	pm_regs[62] = rk818_reg_read(rk818, GASCNT_CAL_REG0);
	pm_regs[63] = rk818_reg_read(rk818, RELAX_ENTRY_THRES_REGH);
	pm_regs[64] = rk818_reg_read(rk818, RELAX_ENTRY_THRES_REGL);
	pm_regs[65] = rk818_reg_read(rk818, RELAX_EXIT_THRES_REGH);
	pm_regs[66] = rk818_reg_read(rk818, RELAX_EXIT_THRES_REGL);
	pm_regs[67] = rk818_reg_read(rk818, CAL_OFFSET_REGH);
...
void warp_rk818_resume (void)
{
  ...
  if( warp_pmic_cold_started )
  {
	...
	rk818_reg_write(rk818, RK818_CLK32OUT_REG, pm_regs[0]);
	rk818_reg_write(rk818, RK818_VB_MON_REG, pm_regs[1]);

	rk818_reg_write(rk818, RK818_DCDC_EN_REG, pm_regs[2]);
	rk818_reg_write(rk818, RK818_LDO_EN_REG, pm_regs[3]);

	rk818_reg_write(rk818, RK818_SLEEP_SET_OFF_REG1, pm_regs[4]);
	rk818_reg_write(rk818, RK818_SLEEP_SET_OFF_REG2, pm_regs[5]);

	rk818_reg_write(rk818, RK818_BUCK1_CONFIG_REG, pm_regs[6]);
	rk818_reg_write(rk818, RK818_BUCK1_ON_REG, pm_regs[7]);
	rk818_reg_write(rk818, RK818_BUCK1_SLP_REG, pm_regs[8]);
//	regs = rk818_reg_read(rk818, RK818_DCDC_EN_REG) | (1 << 0);
//	rk818_reg_write(rk818, RK818_DCDC_EN_REG, regs);

	rk818_reg_write(rk818, RK818_BUCK2_CONFIG_REG, pm_regs[9]);
	rk818_reg_write(rk818, RK818_BUCK2_ON_REG, pm_regs[10]);
	rk818_reg_write(rk818, RK818_BUCK2_SLP_REG, pm_regs[11]);
//	regs = rk818_reg_read(rk818, RK818_DCDC_EN_REG) | (1 << 1);
//	rk818_reg_write(rk818, RK818_DCDC_EN_REG, regs);

	rk818_reg_write(rk818, RK818_BUCK3_CONFIG_REG, pm_regs[12]);
//	regs = rk818_reg_read(rk818, RK818_DCDC_EN_REG) | (1 << 2);
//	rk818_reg_write(rk818, RK818_DCDC_EN_REG, regs);

	rk818_reg_write(rk818, RK818_BUCK4_CONFIG_REG, pm_regs[13]);
	rk818_reg_write(rk818, RK818_BUCK4_ON_REG, pm_regs[14]);
	rk818_reg_write(rk818, RK818_BUCK4_SLP_VSEL_REG, pm_regs[15]);
//	regs = rk818_reg_read(rk818, RK818_DCDC_EN_REG) | (1 << 3);
//	rk818_reg_write(rk818, RK818_DCDC_EN_REG, regs);

	rk818_reg_write(rk818, RK818_BOOST_CONFIG_REG, pm_regs[16]);
	regs = rk818_reg_read(rk818, RK818_DCDC_EN_REG) | (1 << 4);
//	rk818_reg_write(rk818, RK818_DCDC_EN_REG, regs);

	rk818_reg_write(rk818, RK818_LDO1_ON_VSEL_REG, pm_regs[17]);
	rk818_reg_write(rk818, RK818_LDO1_SLP_VSEL_REG, pm_regs[18]);
//	regs = rk818_reg_read(rk818, RK818_LDO_EN_REG) | (1 << 0);
//	rk818_reg_write(rk818, RK818_LDO_EN_REG, regs);

	rk818_reg_write(rk818, RK818_LDO2_ON_VSEL_REG, pm_regs[19]);
	rk818_reg_write(rk818, RK818_LDO2_SLP_VSEL_REG, pm_regs[20]);
//	regs = rk818_reg_read(rk818, RK818_LDO_EN_REG) | (1 << 1);
//	rk818_reg_write(rk818, RK818_LDO_EN_REG, regs);

	rk818_reg_write(rk818, RK818_LDO3_ON_VSEL_REG, pm_regs[21]);
	rk818_reg_write(rk818, RK818_LDO3_SLP_VSEL_REG, pm_regs[22]);
//	regs = rk818_reg_read(rk818, RK818_LDO_EN_REG) | (1 << 2);
//	rk818_reg_write(rk818, RK818_LDO_EN_REG, regs);

	rk818_reg_write(rk818, RK818_LDO4_ON_VSEL_REG, pm_regs[23]);
	rk818_reg_write(rk818, RK818_LDO4_SLP_VSEL_REG, pm_regs[24]);
//	regs = rk818_reg_read(rk818, RK818_LDO_EN_REG) | (1 << 3);
//	rk818_reg_write(rk818, RK818_LDO_EN_REG, regs);

	rk818_reg_write(rk818, RK818_LDO5_ON_VSEL_REG, pm_regs[25]);
	rk818_reg_write(rk818, RK818_LDO5_SLP_VSEL_REG, pm_regs[26]);
//	regs = rk818_reg_read(rk818, RK818_LDO_EN_REG) | (1 << 4);
//	rk818_reg_write(rk818, RK818_LDO_EN_REG, regs);

	rk818_reg_write(rk818, RK818_LDO6_ON_VSEL_REG, pm_regs[27]);
	rk818_reg_write(rk818, RK818_LDO6_SLP_VSEL_REG, pm_regs[28]);
//	regs = rk818_reg_read(rk818, RK818_LDO_EN_REG) | (1 << 5);
//	rk818_reg_write(rk818, RK818_LDO_EN_REG, regs);

	rk818_reg_write(rk818, RK818_LDO7_ON_VSEL_REG, pm_regs[29]);
	rk818_reg_write(rk818, RK818_LDO7_SLP_VSEL_REG, pm_regs[30]);
//	regs = rk818_reg_read(rk818, RK818_LDO_EN_REG) | (1 << 6);
//	rk818_reg_write(rk818, RK818_LDO_EN_REG, regs);

	rk818_reg_write(rk818, RK818_LDO8_ON_VSEL_REG, pm_regs[31]);
	rk818_reg_write(rk818, RK818_LDO8_SLP_VSEL_REG, pm_regs[32]);
//	regs = rk818_reg_read(rk818, RK818_LDO_EN_REG) | (1 << 7);
//	rk818_reg_write(rk818, RK818_LDO_EN_REG, regs);

	rk818_reg_write(rk818, RK818_BOOST_LDO9_ON_VSEL_REG, pm_regs[33]);
	rk818_reg_write(rk818, RK818_BOOST_LDO9_SLP_VSEL_REG, pm_regs[34]);
//	regs = rk818_reg_read(rk818, RK818_DCDC_EN_REG) | (1 << 5);
//	rk818_reg_write(rk818, RK818_DCDC_EN_REG, regs);

	rk818_reg_write(rk818, RK818_DEVCTRL_REG, pm_regs[35]);

	rk818_reg_write(rk818, RK818_INT_STS_MSK_REG1, pm_regs[37]);
//	rk818_reg_write(rk818, RK818_INT_STS_REG1, 0xff);
	rk818_reg_write(rk818, RK818_INT_STS_MSK_REG2, pm_regs[39]);
//	rk818_reg_write(rk818, RK818_INT_STS_REG2, 0xff);
//	rk818_reg_write(rk818, RK818_IO_POL_REG, pm_regs[40]);

#if 0
	rk818_reg_write(rk818, SUP_STS_REG, pm_regs[41]);
	rk818_reg_write(rk818, USB_CTRL_REG, pm_regs[42]);
	rk818_reg_write(rk818, CHRG_CTRL_REG1, pm_regs[43]);
	rk818_reg_write(rk818, CHRG_CTRL_REG2, pm_regs[44]);
	rk818_reg_write(rk818, CHRG_CTRL_REG3, pm_regs[45]);
//	rk818_reg_write(rk818, BAT_CTRL_REG, pm_regs[46]);
//	rk818_reg_write(rk818, BAT_HTS_TS1_REG, pm_regs[47]);
//	rk818_reg_write(rk818, BAT_LTS_TS1_REG, pm_regs[48]);
//	rk818_reg_write(rk818, BAT_HTS_TS2_REG, pm_regs[49]);
//	rk818_reg_write(rk818, BAT_LTS_TS2_REG, pm_regs[50]);
	rk818_reg_write(rk818, TS_CTRL_REG, pm_regs[51]);
	rk818_reg_write(rk818, ADC_CTRL_REG, pm_regs[52]);
//	rk818_reg_write(rk818, ON_SOURCE, pm_regs[53]);
//	rk818_reg_write(rk818, OFF_SOURCE, pm_regs[54]);
	rk818_reg_write(rk818, GGCON, pm_regs[55]);
	rk818_reg_write(rk818, GGSTS, pm_regs[56]);
//	rk818_reg_write(rk818, FRAME_SMP_INTERV_REG, pm_regs[57]);
//	rk818_reg_write(rk818, AUTO_SLP_CUR_THR_REG, pm_regs[58]);
	rk818_reg_write(rk818, GASCNT_CAL_REG3, pm_regs[59]);
	rk818_reg_write(rk818, GASCNT_CAL_REG2, pm_regs[60]);
	rk818_reg_write(rk818, GASCNT_CAL_REG1, pm_regs[61]);
	rk818_reg_write(rk818, GASCNT_CAL_REG0, pm_regs[62]);
	rk818_reg_write(rk818, RELAX_ENTRY_THRES_REGH, pm_regs[63]);
	rk818_reg_write(rk818, RELAX_ENTRY_THRES_REGL, pm_regs[64]);
	rk818_reg_write(rk818, RELAX_EXIT_THRES_REGH, pm_regs[65]);
	rk818_reg_write(rk818, RELAX_EXIT_THRES_REGL, pm_regs[66]);
